...
public class FlashCardEditor extends JPanel {
    ...
    private void jbInit() {
        ...
        add(wordText, new GridBagConstraints(0, 0, 1, 1, 0.7, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        ...
        add(answerPanel, new GridBagConstraints(0, 1, 1, 1, 0.3, 0.0, GridBagConstraints.CENTER,
        ...
        add(pnlButtons, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
