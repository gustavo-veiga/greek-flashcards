...
public class Gtk2ClassicalGreekIM extends SWInputMethod {
    ...
    public String translate(char input) {
        ...
        // System.out.println( "state=" + getState( ) + " input=" + input + "
        ...
        if (0 < getState()) {
            ...
            if (('t' == getState()) || ('T' == getState())) {
                ...
                if ('H' == inputUpper) {
                    ...
                    if ('T' == getState()) {
                        returnValue.append(new char[] { 0x0398 });
                    } else if ('t' == getState()) {
                        returnValue.append(new char[] { 0x03b8 });
                    }
                    ...
                    if ('T' == getState()) {
                        returnValue.append(new char[] { 0x03a4 });
                    } else if ('t' == getState()) {
                        returnValue.append(new char[] { 0x03c4 });
                    }
                ...
                if ('H' == inputUpper) {
                    ...
                    if ('P' == getState()) {
                        returnValue.append(new char[] { 0x03a6 });
                    } else if ('p' == getState()) {
                        returnValue.append(new char[] { 0x03c6 });
                    }

                } else if ('S' == inputUpper) {

                    if ('P' == getState()) {
                        returnValue.append(new char[] { 0x03a8 });
                    } else if ('p' == getState()) {
                        returnValue.append(new char[] { 0x03c8 });
                    }
                    ...
                    if ('P' == getState()) {
                        returnValue.append(new char[] { 0x03a0 });
                    } else if ('p' == getState()) {
                        returnValue.append(new char[] { 0x03c0 });
                    }
                    String translation = (String) characterMap.get(new Integer(input));
                ...
                if ('H' == inputUpper) {
                    ...
                    if ('C' == getState()) {
                        returnValue.append(new char[] { 0x03a7 });
                    } else if ('c' == getState()) {
                        returnValue.append(new char[] { 0x03c7 });
                    }
